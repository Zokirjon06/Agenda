  ...
  final List<Map<String, dynamic>> _data = [
    {
      ...
      "subTitle":
          "Bu yerda siz kunlik qilgan xarajatlaringizni kiritishingiz mumkin",
    },
    {
      "title": "Kunlik xarajatlar",
      "icon": Icons.receipt_long_rounded,
      "subTitle":
          "Bu yerda siz kunlik qilgan ishlaringizni qayd qilib qo'yishingiz mumkin",
    },
    {
      "title": "Ovozli yozuvlar",
      "icon": Icons.mic,
      "subTitle": "Bu yerda siz ovozli yozuvlar qoldirishingiz mumkin",
    }
  ];
